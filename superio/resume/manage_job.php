														...
														<div class="col-xl-12">
                                                                ...
                                                                <table class="table table-bordered table-striped table-responsive-stack" id="tableOne">
                                                                   ...
                                                                   <tbody>
                                                                    ...
                                                                    while($k<$count){
                                                                    $query="SELECT * FROM job_details WHERE admin_id='".$adminid."' ORDER BY job_post_date DESC,job_status"; 
                                                                    ...
                                                                    <td><button class='btn btn-primary' name='repost' ><a class="aa"  href="repost_job.php?id=<?php echo $array['job_id']; ?>">Repost</a></button></td>
                                                                      </tr>
                                                                      <?php 
                                                                    $k++;
                                                                      }
