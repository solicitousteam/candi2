...
$date=date('Y-m-d');
    ...
    $query="UPDATE `job_applications` SET `job_offer_final_date`='".$date."',`job_offer_status`='Accepted',`application_status`='Accepted' WHERE job_id='".$j."' AND candidate_id='".$arrays['candidate_id']." '"; 
...
$array2=mysqli_fetch_assoc($result1);
    ...
    $mail->isHTML(true);                                  
    $mail->Subject = 'Candi.ai Job Offer Accepted';
    $mail->Body = "Dear ".$array2['admin_fname']." ".$array2['admin_lname'].", <br><br> Greetings from Candi.ai!<br> <br> ".$array2['candidate_fname']." ".$array2['candidate_lname']." has accepted the position of  ".$array2['job_title']." as per the details below: <br><br>Offer: $".$array2['job_offer']." ".$array2['job_type']." <br>Date: ".$array2['job_offer_final_date']."<br><br><br>Congratulations!<br><br>Regards,<br>Candi.ai<br> This is a system generated mail please do not reply ";
    $mail->send();
