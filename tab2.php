														...
														<H2 style="margin: 20px 0px 30px 0px;">Interview Sheduled</H2>
                                                                ...
                                                                <table class="table table-bordered table-striped " id="tableOne">
                                                                   ...
                                                                   <tbody>
                                                                         <?php
                                                                         $i=0;
                                                                       $result=mysqli_query($conn,"SELECT * From job_applications LEFT JOIN job_details ON job_details.job_id=job_applications.job_id LEFT JOIN candidate_register ON candidate_register.candidate_id=job_applications.candidate_id WHERE (application_status='Accepted' ||application_status='In Progress' || application_status='Rejected') AND job_details.admin_id=$admin_id");
