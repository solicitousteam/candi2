...
if(isset($_POST['signup'])){
    ...
    $email_check = "SELECT * from super_admin WHERE admin_email = '$email'";
    ...
    if(isset($_POST['check'])){
        ...
        $check_code = "SELECT * from super_admin WHERE code = $otp_code";
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            $code = 0;
            $status = 'verified';
            $update_otp = "UPDATE super_admin SET code = $code, status = '$status' WHERE code = $fetch_code";
    ...
    if(isset($_POST['check-email'])){
        ...
        if(mysqli_num_rows($run_sql) > 0){
           // $code = rand(999999, 111111);
           $code='123456';
            $insert_code = "UPDATE super_admin SET code = $code WHERE admin_email = '$email'";
    ...
    if(isset($_POST['change-password'])){
        ...
        if($password !== $cpassword){
            ...
            $encpass = password_hash($password, PASSWORD_BCRYPT);
            $update_pass = "UPDATE super_admin SET code = $code, admin_password = '$encpass' WHERE admin_email = '$email'";
