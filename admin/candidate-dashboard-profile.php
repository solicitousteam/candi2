                                 ...
                                 <form class="default-form" action="candidate-profile-data.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="facebook" placeholder="www.facebook.com/Example" required>
                                        </div>

                                        <!-- Input -->
                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Twitter</label>
                                            <input type="text" name="twitter" placeholder="www.twitter.com/Example" required>
                                        </div>

                                        <!-- Input -->
                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Linkedin</label>
                                            <input type="text" name="linkedin" placeholder="www.linkedin.com/Example" required>
                                        </div>

                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Skype ID</label>
                                            <input type="text" name="skype" placeholder="Skype ID" required>
                                        </div>

                                        <!-- Input -->
                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Google Plus</label>
                                            <input type="text" name="google" placeholder="www.googleplus.com/Example" required>
                                        </div>
