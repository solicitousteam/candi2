...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
			...
			$query="SELECT sum(job_opening) as total from job_details WHERE admin_id='".$adminid."'";
				...
				<div class="row">
					<div class=col-xl-12>	
						<div class="row">
						    ...
						    <?php if(  isset(  $_SESSION['p_id']  )  && $_SESSION['p_id'] !='') {
						        
						        
						        
						         if( isset(   $_SESSION['role_mj']  ) && $_SESSION['role_mj'] !='' ) { 
	...
	<?php  } if( isset(   $_SESSION['role_re']  ) && $_SESSION['role_re'] !='' ) { ?>  
	    
	    
	   
	    
<?php 	}  if( isset(   $_SESSION['role_cs']  ) && $_SESSION['role_cs'] !='' ) { ?>  
...
<?php } if( isset(   $_SESSION['role_rs']  ) && $_SESSION['role_rs'] !='' ) { ?>  




<?php } if( isset(   $_SESSION['role_ep']  ) && $_SESSION['role_ep'] !='' ) { ?> 
...
<?php } 
									...
									<div class="card-body">
										<div class="media">
											<div class="media-body mr-3">
												<h2 class="text-warning"><?php echo $array['total']; ?></h2>
							...
							<div class="col-xl-2 col-xxl-4 col-lg-4 col-sm-6">
								<div class="card border-card">
									...
									$query="SELECT * FROM job_applications,job_details WHERE job_details.job_id=job_applications.job_id AND admin_id='".$adminid."'";
										$result=mysqli_query($conn,$query);
