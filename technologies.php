							...
							<div class="col-xl-12">
								<div class="d-flex flex-wrap search-job search-job-xl bg-white rounded py-3 px-md-3 px-0 mb-4 align-items-center">
									...
									<div class="col-xl-9 col-xxl-12 col-lg-9 d-flex flex-wrap">
										...
										<a href="javascript:void(0);" class="btn rounded btn-danger  mr-3 mb-0 mb-md-0 mb-sm-2"><i class="las la-upload scale5 mr-3"></i>
						
											Upload Resumes</a>
											<a href="javascript:void(0);" class="btn btn-primary rounded  mb-0 mb-md-0 mb-sm-2"><i class="las la-download scale5 mr-3"></i>Download Resumes</a> 
